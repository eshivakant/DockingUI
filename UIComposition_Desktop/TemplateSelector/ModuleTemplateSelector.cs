...
namespace UIComposition.Shell.TemplateSelector
{
    /// <summary>
    ...
    public class ModuleTemplateSelector : DataTemplateSelector
    {
        ...
        /// used by the <see cref="ModuleTemplateSelector"/>
        /// </summary>
        /// <remarks>
        /// This attached property will allow you to set the templates you wish to be available whenever
        /// a control's TemplateSelector is set to an instance of <see cref="ModuleTemplateSelector"/>
        /// </remarks>
        ...
        /// when using the <see cref="ModuleTemplateSelector"/></returns>
    ...
    /// for the <see cref="ModuleTemplateSelector"/>
    /// </summary>
    /// <remarks>
